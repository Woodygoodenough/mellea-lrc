...
from mellea_lrc.extraction.reading.courts import court_from_reporter_and_level, resolve_court
...
def test_state_reporter_can_complete_an_unnamed_appeals_court_only_when_unique() -> None:
    assert court_from_reporter_and_level("Ct. App.", "ariz") == "arizctapp"
    assert court_from_reporter_and_level("Court of Appeals", "cal") == "calctapp"
    assert court_from_reporter_and_level("Ct. App.", "scotus") is None
    assert court_from_reporter_and_level("Ct. App.", None) is None
