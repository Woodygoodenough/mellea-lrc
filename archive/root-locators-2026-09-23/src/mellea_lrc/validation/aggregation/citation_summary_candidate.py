    ...
    *,
    ...
    if isinstance(assessment, LocatorCandidateAssessmentNode):
        ...
        if evaluation is None:
            return None
        if isinstance(evaluation.record, CourtListenerOpinionCluster):
            return evaluation.record.opinion_url
        absolute_url = evaluation.record.get("absolute_url")
