...
def test_the_case_reporter_closing_period_is_still_required() -> None:
    ...
    Statute patterns have a section symbol in that position instead, so the
    same period is not doing that job there -- which is why widening it is a
    statute question and lives with the statute work, not here.
    """
