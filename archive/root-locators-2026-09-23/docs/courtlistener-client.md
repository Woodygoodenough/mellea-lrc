...
`full_reporter_locator_identity(document, client=...)` takes one. That is the seam for
a cache, a recorded fixture, or a stub in tests, and it is why the client is
